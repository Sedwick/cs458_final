...
const imgLoc = "http://web.engr.oregonstate.edu/~kabirt/cs458/SatelliteMaps/";
...
planetMaterial.map = loader.load(imgLoc+'enceladus.jpg');
//planetMaterial.bumpMap = loader.load(imgLoc+'mirandabump.png');
